    ...
    setup() {
      ...
      const snsBarLinks = [
        ...
        },
        {
          id: "facebook",
          title: "페이스북",
          href: "https://www.facebook.com/SuddenAttack.Korea",
          icon: "facebook",
          external: true,
        },
        {
          id: "youtube",
          title: "유튜브",
          href: "https://www.youtube.com/user/SuddenAttackmkt",
          icon: "youtube",
          external: true,
        },
        {
          id: "instagram",
          title: "인스타그램",
          href: "https://www.instagram.com/Suddenattack_official/",
          icon: "instagram",
          external: true,
        },
      ];
      ...
      const notices = {
        event01: [
          "참여 제한: 본 이벤트는 계정당 1회만 참여 가능하며, 1:1 매칭으로만 진행됩니다. <br class='mobile-hidden'>동일 명의 계정 간에는 듀오 결성이 불가합니다.",
